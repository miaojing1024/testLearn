<template>
  <div class="appDetails">
      ...
      <div class="examine-status am-flex-rc-between" >
        ...
        <div class="item-status green" :class="{'yellow':this.id===1}">已拒绝</div>
      </div>
      <!-- 拒绝原因 -->
      <div class="reject-body">
        <div class="reject-time am-flex-rc-between">
          <div class="time-left">审核时间</div>
          <div class="time-right">2020-11-11</div>
        </div>
        <div class="reject_reason">
          <div class="item_left">拒绝原因</div>
          <Showorno class="inner_details" data="我是拒绝原因阿斯大所大所多as奥阿斯达四大术奥术大师大所大所大所多大师大所大所大所多呀拉屎阿斯达四大所大阿萨斯大所大所大所大所多dasda"/>
        </div>
      </div>
      <!-- 信息详情 -->
      <div class="appBody">
        ...
        <div class="appBodyDetails">
          <div class="details">
              ...
              <Showorno class="inner_details" data="专业承包企业"/>
          </div>
          <div class="details">
              <div class="item_details">联系人</div>
              <Showorno class="inner_details" data="张三"/>
          </div>
          <div class="details">
              <div class="item_details">联系电话</div>
              <Showorno class="inner_details" data="132564862355" />
          </div>
          <div class="details">
              <div class="item_details">经营地址</div>
              <Showorno class="inner_details" data="我是要求爱仕达咕咕咕咕咕咕过阿斯达四大所" :maxLen="50"/>
          </div>
          <div class="details">
              <div class="item_details">申请说明</div>
              <Showorno class="inner_details" data="我是要求爱仕达咕咕咕咕咕咕过过过立刻收到啦开始打开了手动控制不出来看着不像差不多就暗示分离卡还阿斯达四大所多是都拉黑SDK哈师大" :maxLen="50"/>
          </div>
        </div>
      </div>
      <ExamineBottom/>
